...
const Login: NextPage<LoginPageProps> = () => {
  ...
  return (
    <Layout>
      {authCookie ? JSON.stringify({authCookie}, null, 2): <HStack align="start" spacing={4}>
        <Form
          onSubmit={async (data) => {
            loginMutation({
              variables: {
        ...
        >
          <LabeledTextField name="emailOrUsername" label="Email or Username"
                            placeholder="contact@galliary.com | synqat" autoComplete="username" />
          <LabeledTextField name="password" type="password" label="Password" placeholder="••••••" autoComplete="current-password" />
        ...
        >
          <LabeledTextField name="email" type="email" label="Email" placeholder="contact@galliary.com" />
          <LabeledTextField name="username" label="Username" placeholder="synqat" autoComplete="username" />
          <LabeledTextField name="password" type="password" label="Password" placeholder="••••••" autoComplete="current-password" />
          <Button type="submit" variant="primary">
            Register
          </Button>
