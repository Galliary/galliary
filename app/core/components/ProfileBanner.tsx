import { Box, Center, CenterProps, forwardRef, HStack, Img, useBoolean } from "@chakra-ui/react"
import { EditIcon } from "app/core/icons/EditIcon"
import { MotionBox, MotionImage, transitionConfig } from "app/core/components/MotionBox"
import { SaveIcon } from "app/core/icons/SaveIcon"
import { ChangeEvent, useRef, useState } from "react"
import { AnimatePresence } from "framer-motion"
import AvatarEditor from "react-avatar-editor"
import { CDN, ImageType } from "app/core/utils/cdn"
import { useMutation } from "blitz"
import updateCurrentUserBanner from "app/users/mutations/updateCurrentUserBanner"
import { LoadingIconGroup } from "app/core/components/LoadingIconGroup"
import { Maybe } from "types"
import { DeleteIcon } from "app/core/icons/DeleteIcon"
import { CancelIcon } from "app/core/icons/CancelIcon"
...
const ClickableIcon = forwardRef<CenterProps & { tooltip: string }, typeof Center>(
  ({ tooltip, ...props }, ref) => (
    <Box pos="absolute" {...{ right: props.right ?? 16, bottom: props.bottom ?? 4 }}>
      ...
      >
        ...
        {isLoading && (
          <Center pos="absolute" inset={0} boxSize="full" zIndex={10}>
            <LoadingIconGroup isSimple size="50%" />
          </Center>
        )}
        <AnimatePresence exitBeforeEnter>
        ...
        {isOwnProfile && (
          <Box h="full" w="profile.width" pos="relative" pointerEvents="none" zIndex={2}>
            <AnimatePresence exitBeforeEnter>
              <label
