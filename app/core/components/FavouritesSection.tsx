...
import { MotionBox, transitionFastConfig } from "app/core/components/MotionBox"
import { AspectRatio, Box, HStack, Img, Text, useToken, VStack } from "@chakra-ui/react"
...
type AnyItem =
  ...
  | { id: string; avatarUrl: Maybe<string>; username: string; nickname: Maybe<string> }
